...
import { PeriodReportType, AutoReportRequest, api } from "../../services/api";
...
const periodOptions: PeriodOption[] = [
  ...
  {
    type: PeriodReportType.QUARTERLY,
    name: "분기별 레포트",
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <motion.button
        ...
        className={`
          inline-flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-2 
      ...
      >
        ...
        <span className="sm:hidden">{isGenerating ? "생성 중" : "레포트"}</span>
        <ChevronDownIcon
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full right-0 mt-2 w-72 sm:w-80 bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 z-50 overflow-hidden"
          >
