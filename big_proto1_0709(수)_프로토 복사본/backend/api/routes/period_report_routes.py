...
from backend.api.models.period_report_models import (
    AutoReportRequest, EnhancedPeriodReport, PeriodReportType
)
...
@router.post("/generate", response_model=EnhancedPeriodReport)
async def generate_period_report(
    ...
    Returns:
        EnhancedPeriodReport: 생성된 기간별 레포트
    """
